...
class TransientAgent:
    ...
    def __init__(
        ...
        self.mcp_handler = MCPCommandHandler(agent_id=self.agent_id, mcp_fs_url=mcp_fs_url)
    ...
    def _generate_raw_response(self, prompt, system_prompt=None, stream=True) -> str:
        ...
        Returns:
            Raw response string
        """
        print(f"{Colors.BG_GREEN}{Colors.BOLD}[{self.agent_id}] Generating response{Colors.ENDC}")
